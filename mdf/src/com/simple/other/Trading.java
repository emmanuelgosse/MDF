...
public class Trading {
  ...
  public static String NAME = "trading";
  ...
  public static String function(File input) throws IOException {
    ...
    int somme = Integer.parseInt(sc.nextLine());
    ...
    while (sc.hasNextLine()) {
      ...
      int matin = Integer.parseInt(st.nextToken());
      int soir = Integer.parseInt(st.nextToken());

      if (matin <= somme) gain = Math.max(gain, (soir - matin));
